...
# 1. $DATA/monolingual/ml/monolingual.ml
# 2. $DATA/$DATASET/ (the full parallel dataset)
# 3. Make sure that $DATASET is registered in corpora.py
# 4. check format of data files this by default assumes [SPLIT].xx-en.[LANG]
# 5. replace ml with your language.
