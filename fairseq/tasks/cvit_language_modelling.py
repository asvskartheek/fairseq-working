...
@register_task('pretrain_lang_modeling')
class CVITPretrainingTask(FairseqTask):
    ...
    def setup_task(cls, args, **kwargs):
        ...
        ######################### CHANGE THIS #################################################
        args.data = read_config("/content/drive/My Drive/RA-Project-IIIT-H/Assignment_2/fairseq-ilmt/config.yaml")
        ########################################################################################
        if (args.data):
    ...
    def load_dataset(self, split, epoch=0, combine=False, **kwargs):
        ...
        #if (split == 'train'):
        #    split_path = "/home/wannabe/Documents/data/ufal-en-tam/corpus.bcn.dev.train.processed.lmdb"
        #elif (split == 'valid'):
        #    split_path = "/home/wannabe/Documents/data/ufal-en-tam/corpus.bcn.dev.ta.processed.lmdb"
        #elif (split == 'test'):
        #    split_path = "/home/wannabe/Documents/data/ufal-en-tam/corpus.bcn.test.ta.processed.lmdb"
        ...
        #print ("Inside the lang modelling task", self.datasets)
